/* ============================================================
   ...
   - "Find similar songs" through the plugin API
...
(function () {
    ...
    async function loadFilterOptions() {
        try {
            const res = await fetch(curatorUrl('filterOptions'));
    ...
    async function loadClusterPlaylists() {
        try {
            const res = await fetch(curatorUrl('corePlaylists'));
    ...
    async function loadServerPlaylists() {
        ...
        try {
            const res = await fetch(curatorUrl('serverPlaylists'));
            const playlists = await res.json();
    ...
    async function fetchServerPlaylistTracks(seedValue) {
        ...
        try {
            const res = await fetch(curatorUrl('serverPlaylistTracks'), {
                method: 'POST',
    ...
    async function runExtend() {
        ...
        try {
            const res = await fetch(curatorUrl('search'), {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    function rowMeta(t) {
        ...
        const stream = curatorStreamUrl(t.item_id);
